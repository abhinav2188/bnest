...
const About = props => {
    return (
        <div className="flex flex-col items-center w-full md:py-64 py-32 overflow-y-hidden">
            ...
            <div className="flex flex-col lg:w-1/2 md:w-2/3 lg:px-8 md:pr-8 px-4 py-4 ">
                <h1 className="font-heading md:text-6xl text-4xl leading-none pb-16 uppercase text-green-500 tracking-wide ">About Us</h1>
