...
console.log(threeR);
console.log(typeof threeR);
const About = props => {
    return (
        <div className="flex flex-col items-center h-screen md:py-32 py-32 overflow-y-hidden overflow-x-hidden">
            ...
            <div className="flex flex-col lg:w-1/2 md:w-2/3 lg:px-8 md:pr-8 px-4 py-4 ">
                <h1 className="text-gradient-1 md:text-6xl text-4xl leading-none pb-16 text-green-500 font-black ">About Us</h1>
