...
const Products = (props) => {
    return (
        <Container className="flex flex-col items-center my-16 " id="products">
            ...
            <div className="w-full rounded-lg shadow-lg overflow-hidden flex lg:flex-row flex-col md:my-16 my-12">
                <div className="lg:w-1/2 w-full lg:h-96 md:h-72 h-48">
                    <StaticImage className="h-full w-full" src="../assets/images/pd1.jpg" placeholder="blurred"/>
                </div>
                <div className="flex flex-col lg:w-1/2 lg:p-8 p-4 ">
            ...
            <div className="w-full rounded-lg shadow-lg overflow-hidden flex lg:flex-row-reverse flex-col md:my-16 my-12">
                <div className="lg:w-1/2 w-full lg:h-96 md:h-72 h-48">
                    <StaticImage className=" w-full h-full "src="../assets/images/pd2.jpeg" placeholder="blurred" objectPosition="right"/>    
                </div>
                <div className="flex flex-col lg:w-1/2 lg:p-8 p-4 ">
